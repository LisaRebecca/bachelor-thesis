...
\section{Choosing a Dataset}
	The dataset is the fundament of a data-science project. The quality, size, and closeness to reality decide the helpfulness of findings made using the data.
...
\end{table}
	...
	\begin{table}[]
		...
		\begin{tabular}{l|ll}
			...
			\vspace{0.5cm}
			Examples     & \begin{tabular}[c]{@{}l@{}}Sales records, usage statistics, \\ customer feedback\end{tabular}        & \begin{tabular}[c]{@{}l@{}}Historic weather information, \\ consumer statistics, social media data\end{tabular}
		\end{tabular}
	\end{table}
