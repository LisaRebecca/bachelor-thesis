...
The \ac{DBSCAN} model identified the outlier data (\ref{fig:dbscan-outliers}), amounting to about 3\% of the data points.
...
\subsection{Train a KMeans Model with cosine distance}
